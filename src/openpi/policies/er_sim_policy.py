...
def make_aloha_example() -> dict:
    ...
    return {
        ...
        "prompt": "Pick and place object",
    }


@dataclasses.dataclass(frozen=True)
class ERsimInputs(transforms.DataTransformFn):
    ...
    EXPECTED_CAMERAS: ClassVar[tuple[str, ...]] = ("cam_base",)
...
@dataclasses.dataclass(frozen=True)
class ERsimOutputs(transforms.DataTransformFn):
